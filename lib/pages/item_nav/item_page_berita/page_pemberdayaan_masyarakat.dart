...
class PagePemberdayaanMasyarakat extends StatefulWidget {
  @override
  State<PagePemberdayaanMasyarakat> createState() =>
      _PagePemberdayaanMasyarakatState();
}

class _PagePemberdayaanMasyarakatState
    extends State<PagePemberdayaanMasyarakat> {
                  ...
                  if (data.length != 0) {
                    ...
                    return Center(
                      ...
                      children: [
                        ...
                        Text(
                          "Belum Ada Berita Pemberdayaan Masyarakat",
                          style: TextStyle(
