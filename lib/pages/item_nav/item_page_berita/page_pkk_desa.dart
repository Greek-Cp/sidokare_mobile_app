...
class PagePKK extends StatefulWidget {
  @override
  State<PagePKK> createState() => PagePKKDesaState();
}

class PagePKKDesaState extends State<PagePKK> {
  ...
  Widget build(BuildContext context) {
    ...
    listBerita = fetchBeritaKustom("ktg_berita02");
    return Scaffold(
      body: Padding(
